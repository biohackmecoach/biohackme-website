...
interface MasterclassWelcomeEmailData {
  email: string;
  firstName?: string;
  accessLink: string;
 ...
 */
export async function sendMasterclassWelcomeEmail(data: MasterclassWelcomeEmailData): Promise<boolean> {
  try {
 ...
 */
function generateMasterclassWelcomeHTML(data: MasterclassWelcomeEmailData): string {
  return `
<!DOCTYPE html>
<html>
<head>
 ...
 */
function generateMasterclassWelcomeText(data: MasterclassWelcomeEmailData): string {
  return `
 ...
 */
export async function sendEmailViaSendGrid(data: MasterclassWelcomeEmailData): Promise<boolean> {
 ...
 */
export async function createPDFAccessToken(email: string, productType: string): Promise<string> {
  ...
  await admin.firestore().collection('download_tokens').add({
    ...
    expiresAt: null, // Set to timestamp if you want expiring links
    used: false
  });
 ...
 */
export function generatePDFDownloadLink(token: string): string {
